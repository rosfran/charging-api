package com.fastned.solarcharging.common;
...
public final class Constants {
    ...
    public static final String NOT_FOUND_SOLAR_GRID = "Requested solar grid is not found";
    public static final String NOT_FOUND_STATE = "Requested state is not found";
    public static final String NOT_FOUND_NETWORK = "Requested network is not found";
    ...
    public static final String ALREADY_EXISTS_SOLAR_GRID = "SolarGrid with the same name is already exists";
    public static final String ALREADY_EXISTS_USER = "User with the same username is already exists";
    public static final String CREATED_SOLAR_GRID = "SolarGrid is created";
    public static final String CREATED_NETWORK = "Network is created";
    public static final String CREATED_USER = "User is created";
    public static final String UPDATED_SOLAR_GRID = "SolarGrid is updated";
    public static final String UPDATED_NETWORK = "Network is updated";
    public static final String UPDATED_USER = "User is updated";
    public static final String DELETED_SOLAR_GRID = "SolarGrid is deleted";
    public static final String DELETED_NETWORK = "Network is deleted";
