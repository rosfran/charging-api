...
public final class Constants {
    ...
    public static final String ALREADY_EXISTS_TYPE = "SolarGrid with the same name is already exists";
    public static final String ALREADY_EXISTS_USER = "User with the same username is already exists";
    public static final String CREATED_TYPE = "SolarGrid is created";
    public static final String CREATED_PET = "Network is created";
    public static final String CREATED_USER = "User is created";
    public static final String UPDATED_TYPE = "SolarGrid is updated";
    public static final String UPDATED_PET = "Network is updated";
    public static final String UPDATED_USER = "User is updated";
    public static final String DELETED_TYPE = "SolarGrid is deleted";
    public static final String DELETED_PET = "Network is deleted";
